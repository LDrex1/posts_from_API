  ...
  <div class="container mb-3">
        <div class="card">
          ...
          <div class="container d-felx flex-wrap justify-content-around">
              <button class="rounded text-primary" onclick="viewPost(${post.id})">View</button>
              <button class="rounded text-info" onclick="updatePost(${post.id})">Update</button>
              <button class="rounded text-danger"onclick="deletePost(${post.id})">Delete</button>
          </div>
        </div>
      </div>
  `;
